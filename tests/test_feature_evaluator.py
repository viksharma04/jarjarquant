...
class TestDataServiceDatabase:
    def test_save_to_database_with_polars_dataframe(self):
        ...
        ds.db_path.__truediv__ = MagicMock(return_value="test_path.parquet")
    ...
    def test_save_to_database_empty_data(self):
        ...
        with pytest.raises(ValueError, match="Cannot save empty or None data"):
            ds.save_to_database(None, "test_table")
    ...
    def test_load_from_database_existing_file(self):
        ...
        with patch('polars.read_parquet', return_value=expected_data) as mock_read:
...
class TestParallelIndicatorDistributionStudy:
    @patch('jarjarquant.feature_evaluator.FeatureEvaluator.indicator_distribution_study')
    def test_parallel_indicator_distribution_study_save_run_false(self, mock_study):
        ...
        sample_request = SampleRequest("equities", "2023-01-01", "2023-01-02", n_samples=2)
    ...
    @patch('jarjarquant.feature_evaluator.FeatureEvaluator.indicator_distribution_study')
    def test_parallel_indicator_distribution_study_save_run_true(self, mock_study, mock_save):
        ...
        # Create mock indicator spec
        indicator_spec = IndicatorSpec(IndicatorType.RSI, {"period": 14})
        sample_request = SampleRequest("equities", "2023-01-01", "2023-01-02", n_samples=1)
    ...
    def test_save_detailed_results(self):
        ...
        expected_columns = [
            "indicator", "ticker", "bar_size", "start_date", "end_date",
            "indicator_params", "timestamp", "adf_statistic", "adf_pvalue"
        ]
