...
def data_service():
    ...
    # Use the actual sample data path that DataService expects by default
    # DataService uses jarjarquant/db/sample_data as default
    service = DataService()  # Use default path
    yield service
    service.close()
...
class TestDataService:
    ...
    def test_context_manager(self):
        ...
        with DataService() as service:  # Use default path
